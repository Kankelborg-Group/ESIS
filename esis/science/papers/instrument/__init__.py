...
# isolated emission line formed in the lower \TR."""
        ...
        doc.append(sections.science_objectives.magnetic_reconnection_events.subsection())

        doc.append(sections.science_objectives.energy_transfer.subsection())

        doc.append(sections.science_objectives.requirements.subsection())
